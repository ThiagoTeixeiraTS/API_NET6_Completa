...
namespace ProjetoAPI2022
{
    ...
    public class UnitTest1
    {
        ...
        {
            var result = ChamaApiPost("https://localhost:7129/api/List").Result;
        ...
        public void GetToken()
        {
            ...
            string urlApiGeraToken = "https://localhost:7129/api/CriarTokenIdentity";

            using (var cliente = new HttpClient())
            {
                string login = "Renato@ThiagoTeixeira.net";
                string senha = "renatoS2*";
                var dados = new
                {
                    email = login,
                    senha = senha,
